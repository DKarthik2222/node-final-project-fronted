...
const Footer = () => {
    return (
        <div className={style.Footer__Footer__2T3w3} >
            <div className={style.Footer__Row__2Koch}>
                <div className={style.Footer__Column__1mRXM}>
                    <h3 className={style.Footer__ColumnHeading__sK9kQ}>EDYODA</h3>
                ...
                <div className={style.Footer__Column__1mRXM}>
                    <h3 className={style.Footer__ColumnHeading__sK9kQ}>RESOURCES</h3>
                ...
                <div className={`${style.Footer__Column__1mRXM} ${style.Footer__SocialLinksContainer__2kpSA}`}>
